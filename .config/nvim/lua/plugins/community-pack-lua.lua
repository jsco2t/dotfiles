...
-- including custom version of community pack for lua as `selene` is not currently
-- supported on `arm64` (dispite compiling and running fine on arm64)
...
return {
  ...
  },
  {
    ...
    optional = true,
    opts = function(_, opts)
      opts.ensure_installed = require("astrocore").list_insert_unique(opts.ensure_installed, { "stylua" }) -- removed "selene"
  ...
  },
  {
    ...
    opts = function(_, opts)
      opts.ensure_installed =
        require("astrocore").list_insert_unique(opts.ensure_installed, { "lua-language-server", "stylua" }) -- removed "selene"
    end,
  },
  {
